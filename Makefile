...
all: genanysort valsort

ifeq ($(USE_SUMP_PUMP),1)
# {
genanysort: genanysort.c rand16.o rand16.h sump.o
  gcc -g $(CFLAGS) -o genanysort -DSUMP_PUMP genanysort.c rand16.o sump.o -lz -lpthread -ldl -lrt
...
# {
genanysort: genanysort.c rand16.o rand16.h
	gcc -g $(CFLAGS) -o genanysort genanysort.c rand16.o -lz
